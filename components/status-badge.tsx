...
const prospectStatusConfig: Record<ProspectStatus, { label: string; className: string }> = {
  ...
  education_sent:        { label: 'Education Sent',       className: 'bg-sky-100 text-sky-700 border-sky-200' },
  handoff_pending:       { label: 'Handoff Pending',      className: 'bg-purple-100 text-purple-700 border-purple-200' },
  handed_off:            { label: 'Handed Off',           className: 'bg-indigo-100 text-indigo-700 border-indigo-200' },
  onboarding:            { label: 'Onboarding',           className: 'bg-orange-100 text-orange-700 border-orange-200' },
...
export function ReferralRewardBadge({ status }: ReferralRewardBadgeProps) {
